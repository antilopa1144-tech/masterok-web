...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Что такое Мастерок: строительные калькуляторы для расчёта материалов, ремонта и отделки. Как устроены формулы, практический запас, упаковка материалов, ключевые разделы и ограничения сервиса.",
  url: PAGE_URL,
});
