...
const META = {
  ...
  description:
    `${CALC_COUNT}+ бесплатных строительных калькуляторов: бетон, кирпич, плитка, ламинат, кровля, обои, гипсокартон. Нормы расхода, запас и упаковки. С ИИ-прорабом Михалыч.`,
} as const;
...
const UI_TEXT = {
  ...
  stats: [
    ...
    { val: "К покупке", label: "С упаковками" },
  ],
...
const FEATURES = [
  {
    ...
    desc: "Геометрия, нормы расхода, практический запас и округление до упаковок показаны отдельными этапами.",
  },
  {
    icon: "engineering",
    color: "#06B6D4",
