...
import { buildLinearCutHrefFromWallSlat } from "@/lib/tools/wall-slat-to-linear-cut";
...
export default function WallSlatPlanner() {
  ...
  const linearCutHref = useMemo(() => buildLinearCutHrefFromWallSlat(result), [result]);
