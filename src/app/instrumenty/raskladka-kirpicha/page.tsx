...
const META = {
  description:
    "Визуализатор кирпичной кладки: ложковая, цепная, фламандская и баварская перевязка. Схема рядов, подрезки и ориентировочное количество кирпича с настраиваемым запасом.",
};
      ...
      <div className="bg-gradient-to-b from-orange-50 to-white dark:from-slate-900 dark:to-slate-950 border-b border-slate-200 dark:border-slate-800">
        <div className="page-container py-6">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2 max-w-2xl">
            Выберите тип перевязки и размеры — увидите схему рядов, подрезки и ориентировочное количество кирпича с понятным запасом на бой.
          </p>
        </div>
      </div>
