...
const META = {
  description:
    "Визуализатор кирпичной кладки: ложковая, цепная, фламандская и баварская перевязка. Введите размеры стены и кирпича — увидите схему и количество кирпича к покупке.",
};
