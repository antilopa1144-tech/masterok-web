...
const META = {
  ...
  description: "Готовые пошаговые чек-листы для ремонта: отмечайте выполненное с сохранением в браузере, скачивайте PDF или распечатывайте.",
} as const;
...
const UI_TEXT = {
  ...
  heroDescription: "Готовые пошаговые инструкции: отмечайте выполненное прямо на объекте, продолжайте после перезагрузки, скачивайте PDF или распечатывайте.",
  checklistItemsSuffix: "пунктов",
  checklistStepsSuffix: "этапов работ",
  ctaTitle: "Используйте на объекте",
  ctaDescription: "Откройте чек-лист на телефоне и отмечайте выполненное — прогресс сохранится в этом браузере. Для отдельной копии скачайте PDF или используйте печать.",
