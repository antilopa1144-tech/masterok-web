    ...
    <>
      ...
      <section className="border-b border-slate-200 bg-linear-to-b from-white to-slate-50">
        <div className="page-container-wide py-10 md:py-14">
          <nav className="flex items-center gap-1.5 text-sm text-slate-400 mb-5">
            ...
            <span>/</span>
            <span className="text-slate-600">Чек-листы</span>
          </nav>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs text-slate-400 font-medium">{cl.category}</span>
                </div>

                {/* Заголовок */}
                <h2 className="font-bold text-slate-900 text-base leading-snug mb-1.5 group-hover:text-accent-600 transition-colors">
                  {cl.title}
                </h2>
                ...
                <div className="mt-4 pt-3 border-t border-slate-200">
                  <p className="text-xs text-slate-400">{cl.steps.length} этапов работ</p>
                </div>
              </Link>
            );
          })}
      ...
      <section className="page-container-wide pb-12">
        <div className="bg-linear-to-br from-violet-50 to-violet-100 rounded-2xl p-8 text-center">
          ...
          <h2 className="text-xl font-bold text-slate-900 mb-2">Используйте на объекте</h2>
