...
export default function LightingLayoutPlanner() {
  ...
  return (
    <div ref={workspaceTopRef} className="space-y-4 scroll-mt-24 xl:grid xl:grid-cols-[minmax(280px,0.85fr)_minmax(0,1.65fr)_minmax(280px,0.85fr)] xl:items-start xl:gap-4 xl:space-y-0">
