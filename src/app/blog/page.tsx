...
const META = {
  ...
  description: "Рекомендательные статьи о строительстве и ремонте: расчёт материалов, технологии укладки плитки, стяжки, гипсокартона и практические советы.",
} as const;
...
const UI_TEXT = {
  ...
  heroDescription: "Понятные рекомендательные материалы о расчёте стройматериалов, технологиях монтажа и выборе материалов.",
  readMore: "Читать →",
