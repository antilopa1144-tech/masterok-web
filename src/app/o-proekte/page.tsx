    ...
    <div>
      ...
      <section className="page-container py-10 md:py-16">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            <h2>Если расчёт расходится с практикой</h2>
            <p>
              Мы правим формулы и нормы расхода, когда находим ошибку или когда производитель
              меняет фасовку и расход. Если результат разошёлся с вашим опытом или паспортом
              материала, напишите через форму обратной связи — она открывается по ссылке
              «Оставить отзыв» в подвале сайта. В сообщении укажите калькулятор, введённые
              значения и то, что получилось: так ошибку можно воспроизвести и закрыть тестом.
            </p>
            <p>
              Каждый калькулятор показывает <Link href="/metodologiya/">источники норм</Link> и
              отдельно — точную потребность и итог к покупке, чтобы расхождение было видно сразу.
            </p>
          </section>
        </div>
      </section>
