          ...
          return (
            <section key={cat.id}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-sm text-slate-400">({calcs.length})</span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {calcs.map((calc) => (
                  ...
                  >
                    <h3 className="font-bold text-slate-900 text-sm mb-1 group-hover:text-accent-600 transition-colors">
                      {calc.title}
                    </h3>
