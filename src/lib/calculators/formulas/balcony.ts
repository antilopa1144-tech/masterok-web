...
export const balconyDef: CalculatorDefinition = {
  ...
  metaTitle: withSiteMetaTitle("Калькулятор отделки балкона: материалы онлайн"),
  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 1, label: "Пластиковые панели (ПВХ), 100 мм" },
        { value: 2, label: "Имитация бруса 14×96 мм" },
        { value: 3, label: "Древесноволокнистые панели (МДФ), 240 мм" },
      ],
    },
    {
      key: "insulationType",
      ...
      options: [
        ...
        { value: 3, label: "Экструдированный пенополистирол 50 мм + пенофол 10 мм" },
      ],
    },
  ],
  calculate(inputs) {
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Пластиковые панели (ПВХ, 100 мм)</td><td>~10 шт/м²</td><td>Брусок 20&times;40, шаг 400 мм</td></tr>
    <tr><td>Имитация бруса (96 мм)</td><td>~11 шт/м²</td><td>Брусок 30&times;40, шаг 500 мм</td></tr>
    <tr><td>Древесноволокнистые панели (МДФ, 240 мм)</td><td>~4 шт/м²</td><td>Брусок 20&times;40, шаг 400 мм</td></tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr><td>Пенопласт (пенополистирол)</td><td>50</td><td>~1.25</td></tr>
    <tr><td>Пенофол фольгированный</td><td>10</td><td>~0.25 + отражение ИК</td></tr>
    <tr><td>Экструдированный пенополистирол 50 мм + пенофол 10 мм</td><td>60</td><td>~1.6</td></tr>
  </tbody>
</table>
