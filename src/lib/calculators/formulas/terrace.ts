...
export const terraceDef: CalculatorDefinition = {
  ...
  title: "Калькулятор террасной доски и ДПК",
  h1: "Калькулятор террасной доски и ДПК — раскрой и закупка",
  description:
    "Рассчитайте террасную доску из ДПК или дерева по направлению рядов, фактической рабочей ширине, зазору, длине товара, явному запасу и фасовке. Лаги, крепёж и подготовку добавляйте только по проектной ведомости.",
  metaTitle: withSiteMetaTitle("Калькулятор террасной доски и ДПК: расчёт"),
  metaDescription:
    "Бесплатный калькулятор террасной доски и ДПК: рассчитайте ряды, раскрой, запас и пачки по фактическому профилю; лаги и крепёж — по проектным данным.",
  category: "facade",
  categorySlug: "fasad",
  tags: [
    "террасная доска",
...
<h2>ДПК и деревянная доска: что меняется во входных данных</h2>
<p>Для ДПК и деревянной доски геометрическая модель расчёта одинакова: калькулятор строит ряды и раскрой по размерам выбранного товара. Введите фактическую рабочую ширину, длину доски, монтажный зазор и число досок в упаковке из паспорта или инструкции производителя. Материалы различаются температурными и влажностными деформациями, крепежом, обработкой и требованиями к подконструкции, поэтому эти значения нельзя переносить между системами.</p>

<h2>Почему нет универсального шага лаг и расхода крепежа</h2>
<p><a href="https://protect.gost.ru/gost/details/173319f4-ea75-4a7f-baca-76851db03644">ГОСТ Р 59555-2021 с изменением № 1</a> задаёт технические требования к профильным изделиям из древесно-полимерного композита для наружного применения, но не превращает площадь настила в готовый проект подконструкции. Для деревянных несущих элементов действует область проектирования <a href="https://protect.gost.ru/sp/details/cbac2ac8-70ea-4899-9b3b-1c402a1260d0">СП 64.13330.2017</a>. Поэтому лаги и крепёж появляются только по готовой ведомости.</p>
