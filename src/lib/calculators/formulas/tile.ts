...
сложность помещения и формат плитки. Для точного итога к покупке укажите количество плиток в коробке по этикетке;
режим по площади коробки остаётся предварительной оценкой.
