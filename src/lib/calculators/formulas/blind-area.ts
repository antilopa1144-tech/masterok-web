...
export const blindAreaDef: CalculatorDefinition = {
  ...
  metaTitle: withSiteMetaTitle("Калькулятор отмостки: расчёт материалов онлайн"),
  metaDescription: "Бесплатный калькулятор отмостки: рассчитайте бетон, щебень, песок и экструдированный пенополистирол для устройства отмостки вокруг дома.",
  category: "foundation",
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Утеплитель (опционально)</td><td>50&ndash;100</td><td>Экструдированный пенополистирол (ЭППС)</td></tr>
