...
export const basementDef: CalculatorDefinition = {
  ...
  metaTitle: withSiteMetaTitle("Калькулятор подвала: расчёт материалов онлайн"),
  metaDescription: "Бесплатный калькулятор подвала: рассчитайте бетон, арматуру, гидроизоляцию стен и пола, утепление экструдированным пенополистиролом.",
  category: "foundation",
