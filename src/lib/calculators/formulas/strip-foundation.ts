...
export const stripFoundationDef: CalculatorDefinition = {
  ...
  metaTitle: withSiteMetaTitle("Калькулятор ленточного фундамента"),
...
`,
    faq: [
      ...
      },
      {
        ...
        answer: "<p>Глубина заложения фундамента зависит от глубины промерзания грунта в регионе и типа грунта:</p><table><thead><tr><th>Регион</th><th>Глубина промерзания</th><th>Минимум заложения</th></tr></thead><tbody><tr><td>Москва, Центральный федеральный округ</td><td>1.4 м</td><td>0.7&ndash;1.5 м</td></tr><tr><td>Санкт-Петербург</td><td>1.2 м</td><td>0.6&ndash;1.3 м</td></tr><tr><td>Новосибирск</td><td>2.2 м</td><td>1.1&ndash;2.3 м</td></tr></tbody></table><p>Для мелкозаглублённых ленточных фундаментов допускается заложение 0.3&ndash;0.7 м при условии утепления отмостки по <strong>СП 22.13330</strong>.</p>",
      },
    ],
  },
};
