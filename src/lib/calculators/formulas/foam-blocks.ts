...
export const foamBlocksDef: CalculatorDefinition = {
  ...
  metaDescription: "Бесплатный калькулятор пеноблоков: рассчитайте количество блоков D600/D800, керамзитоблоков М50/М75, клея и кладочной сетки. По ГОСТ 21520-89.",
  category: "walls",
  categorySlug: "steny",
