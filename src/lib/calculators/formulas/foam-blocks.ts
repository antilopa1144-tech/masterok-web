...
`,
    faq: [
      ...
      },
      {
        ...
        answer: "<p>Выбор между полнотелым и пустотелым керамзитоблоком зависит от назначения:</p><ul><li><strong>Полнотелый</strong> (M75&ndash;M100) &mdash; для несущих стен, фундамента цоколя, столбов. Масса ~17 кг</li><li><strong>Двухпустотный</strong> (M50&ndash;M75) &mdash; для несущих стен 1&ndash;2 этажа. Масса ~14 кг, лучше теплоизоляция</li><li><strong>Многопустотный</strong> (M35&ndash;M50) &mdash; для перегородок и ненагруженных стен. Масса ~10 кг</li></ul><p>Нормативный документ: <strong>ГОСТ 6133-99</strong>. При кладке пустотелых блоков раствор не должен заполнять пустоты.</p>",
      },
    ],
  },
};
