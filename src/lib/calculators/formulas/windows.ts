...
export const windowsDef: CalculatorDefinition = {
  ...
  h1: "Калькулятор установки окон — монтажная пена по фактическому шву",
  description:
    "Рассчитайте, сколько монтажной пены нужно для установки окон по размерам блока, ширине и глубине шва и полезному выходу выбранного баллона.",
  metaTitle: withSiteMetaTitle("Калькулятор установки окон и монтажной пены"),
  metaDescription:
    "Бесплатный калькулятор установки окон: рассчитайте, сколько монтажной пены нужно по размерам блока и шва, а откосы и ленты — по проектным данным.",
  category: "interior",
...
<h2>Окна перед отопительным сезоном: что можно посчитать</h2>
<p>Для новой установки или замены окна калькулятор отвечает на закупочный вопрос: сколько монтажной пены нужно для центрального слоя принятого шва. Введите габарит блока, фактическую ширину зазора, глубину заполнения и консервативный полезный выход баллона. Универсального числа баллонов «на одно окно» нет: одинаковые рамы в ровном и разрушенном проёме дают разный объём.</p>
<p>Страница не рассчитывает оконный блок: размеры проёма под заказ, профиль, стеклопакет, створки, сопротивление теплопередаче, нагрузку и стоимость конструкции определяют отдельно. Площадь внутренних откосов перенесите из <a href="/kalkulyatory/otdelka/otkosy-okon-i-dverej/">калькулятора откосов</a>; здесь она только переводится в фасовку уже выбранного материала.</p>
<p>Если существующее окно продувается, промерзает или покрывается конденсатом, этот расчёт не устанавливает причину. Нужны осмотр створок, уплотнений и монтажного шва, а также проверка температуры поверхности, влажности и воздухообмена. Для других частей квартиры используйте <a href="/kalkulyatory/fasad/uteplenie/">калькулятор закупки утеплителя</a> после принятия конструкции и <a href="/kalkulyatory/inzhenernye/ventilyaciya/">калькулятор вентиляции</a> по проектному расходу воздуха.</p>
