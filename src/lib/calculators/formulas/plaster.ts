...
export const plasterDef: CalculatorDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      defaultValue: 0,
      options: [
        { value: 0, label: "Гипсовая (Knauf Ротбанд, Волма Слой)" },
...
`,
    faq: [
      ...
      },
      {
        ...
        answer: "<p>В калькуляторе для Волма Слой используется расход <strong>8.5 кг на 1 м&sup2;</strong> при толщине слоя 10 мм, или 0.85 кг на 1 м&sup2; на каждый миллиметр слоя.</p><p>Пример: для 30 м&sup2; при слое 15 мм точная потребность составляет 382.5 кг. С практическим запасом 10% получится 420.75 кг, поэтому к покупке нужно <strong>15 мешков по 30 кг</strong>.</p><p>Фактический расход зависит от перепадов стены; среднюю толщину слоя определяют промером основания до установки маяков.</p>",
      },
      {
      ...
      },
      {
        ...
        answer: "<p>Армирование штукатурки обязательно в следующих случаях:</p><ul><li>Толщина слоя <strong>свыше 30 мм</strong> (для гипсовых) или <strong>свыше 20 мм</strong> (для цементных)</li><li>Стыки разнородных материалов (кирпич + бетон, газоблок + монолит)</li><li>Оштукатуривание по утеплителю в системе мокрого фасада</li><li>Потолки и откосы — зоны повышенного риска трещин</li></ul><p>Используют стеклосетку плотностью <strong>160 г/м&sup2;</strong> для внутренних работ и <strong>160–320 г/м&sup2;</strong> для фасадов. Сетка утапливается в первый слой штукатурки на глубину 1/3 от общей толщины.</p>",
      },
    ],
  },
};
