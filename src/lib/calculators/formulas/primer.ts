...
export const primerDef: CalculatorDefinition = {
  ...
  metaTitle: withSiteMetaTitle(
    "Калькулятор грунтовки на 1 м²: расход и упаковки",
  ),
  metaDescription:
    "Бесплатный калькулятор грунтовки: рассчитайте расход на 1 м² для стен, потолка и пола по норме производителя, целые упаковки и остаток.",
  category: "interior",
