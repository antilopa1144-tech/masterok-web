...
export const soundInsulationDef: CalculatorDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      defaultValue: 0,
      options: [
        { value: 0, label: "Базовая каркасная система: гипсокартон + акустическая вата" },
        { value: 1, label: "Звукоизоляционные сэндвич-панели (ЗИПС)" },
...
<table>
  ...
  <tbody>
    <tr><td>Базовая каркасная система</td><td>+10–12</td><td>80–100</td><td>Акустическая вата, два слоя гипсокартона, виброподвесы</td></tr>
    <tr><td>Звукоизоляционные сэндвич-панели (ЗИПС)</td><td>+9–13</td><td>55–133</td><td>ЗИПС-Модуль / ЗИПС-III-Ультра, гипсокартон</td></tr>
    <tr><td>Плавающий пол</td><td>+20–25 (ударный)</td><td>60–80</td><td>Виброизол, стяжка 40 мм, демпферная лента</td></tr>
    <tr><td>Акустический потолок</td><td>+8–12</td><td>100–150</td><td>Виброподвесы, вата, два слоя гипсокартона</td></tr>
  </tbody>
</table>
