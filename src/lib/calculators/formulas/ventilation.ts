...
export const ventilationDef: CalculatorDefinition = {
  ...
  h1: "Калькулятор вентиляции квартиры и дома — расход воздуха и воздуховоды",
  description:
  ...
  metaTitle: withSiteMetaTitle("Калькулятор вентиляции квартиры и дома"),
  metaDescription:
  ...
  tags: ["вентиляция", "вентиляция квартиры", "расход воздуха", "скорость воздуха", "воздуховод", "СП 60.13330"],
  popularity: 62,
  complexity: 3,
  fields: [
    {
...
<h2>Квартира зимой: приток, вытяжка и конденсат на окнах</h2>
<p>Закрытые окна уменьшают неконтролируемый приток, поэтому наличие вытяжной решётки ещё не гарантирует воздухообмен. Для квартиры проверяют путь воздуха целиком: приток в жилые комнаты, переток через двери и вытяжку из кухни и санузлов. Калькулятор показывает предварительный расход, но не диагностирует тягу общедомового канала и не назначает приточный клапан по одной площади.</p>
<p>Конденсат на стекле может быть связан с влажностью, температурой внутренней поверхности, монтажным швом и воздухообменом. Проверьте геометрию шва в <a href="/kalkulyatory/otdelka/ustanovka-okon/">калькуляторе установки окон</a>, а тепловую нагрузку комнаты — в <a href="/kalkulyatory/inzhenernye/otoplenie-radiatory/">калькуляторе радиаторов</a>. Утеплитель для уже принятой конструкции считает <a href="/kalkulyatory/fasad/uteplenie/">калькулятор утепления дома и квартиры</a>; выбор внутреннего узла требует теплотехнической и влажностной проверки.</p>
