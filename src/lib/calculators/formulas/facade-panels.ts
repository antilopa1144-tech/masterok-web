...
<p>Проектную толщину здесь не подбирают: упаковки уже выбранного материала проверьте в <a href="/kalkulyatory/fasad/uteplenie/">калькуляторе утеплителя</a>. Если нужна только облицовка без предварительных позиций подсистемы, используйте <a href="/kalkulyatory/fasad/sayding/">калькулятор сайдинга</a> с рабочей длиной, шириной и явным запасом.</p>
    `,
    faq: [
      {
