...
const GRADE_LABELS: Record<number, string> = {
  1: "М100", 2: "М150", 3: "М200", 4: "М250",
  5: "М300", 6: "М350", 7: "М400",
};
...
export const concreteDef: CalculatorDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      defaultValue: 3,
      options: [
        { value: 1, label: "М100 — подбетонка, дорожки" },
        { value: 2, label: "М150 — стяжки, отмостки" },
        { value: 3, label: "М200 — фундаменты, плиты" },
        { value: 4, label: "М250 — монолитные плиты" },
        { value: 5, label: "М300 — несущие конструкции" },
        { value: 6, label: "М350 — гидротехнические" },
        { value: 7, label: "М400 — высоконагруженные" },
      ],
    },
    {
      key: "manualMix",
