...
export const ceilingInsulationDef: CalculatorDefinition = {
  ...
  description: "Рассчитайте количество минеральной ваты или экструдированного пенополистирола (ЭППС), пароизоляции и крепежа.",
...
- Экструдированный пенополистирол (1200×600 мм): ⌈Площадь × 1.05 / 0.72⌉ плит
...
<ul>
  ...
  <li><strong>Экструдированный пенополистирол (ЭППС, плиты 1200&times;600)</strong> = S &times; 1.05 / 0.72 м²</li>
  <li><strong>Пароизоляция</strong> = S &times; 1.15 / S<sub>рулона</sub></li>
  <li><strong>Тарельчатые дюбели («грибки»)</strong> = S &times; 5 шт/м² (для плитного утеплителя)</li>
</ul>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Экструдированный пенополистирол (ЭППС)</td><td>30 / 50 / 100</td><td>плита 1200&times;600</td><td>0.72 м²</td></tr>
