...
export const septicRingsDef: CalculatorDefinition = {
  ...
  metaDescription: "Бесплатный калькулятор септика из ЖБИ-колец: проверьте минимальный рабочий объём, геометрическое число колец, днищ и перекрытий без подмены проекта фильтрации.",
