...
<p>Дополнительно рассчитываются: арматурная сетка (верхний и нижний пояс), подготовка основания (щебень + песок) и утепление экструдированным пенополистиролом (ЭППС).</p>
