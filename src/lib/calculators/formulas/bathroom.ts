...
export const bathroomDef: CalculatorDefinition = {
  ...
  h1: "Калькулятор ванной комнаты — площадь пола, стен и плитка",
  description:
    "Рассчитайте площадь пола и стен ванной, затем количество плитки и коробок по обмеру, размерам выбранных артикулов, запасу и фасовке.",
  metaTitle: withSiteMetaTitle(
    "Калькулятор ванной комнаты: площадь стен и плитка",
  ),
  metaDescription:
    "Бесплатный калькулятор ванной комнаты: рассчитайте площадь пола и стен с вычетом проёмов, количество плитки и коробок по фактической фасовке.",
  category: "interior",
...
<h2>Ремонт ванной в квартире осенью и зимой</h2>
<p>Отопление и закрытые окна не подтверждают готовность основания, гидроизоляции или клеевого слоя. Температуру основания и воздуха, влажность, межслойные выдержки и сроки дальнейших работ проверяйте по техкартам выбранных материалов. Калькулятор площади и плитки не измеряет эти условия и не сокращает время сушки.</p>
<p>Для мокрой зоны отдельно проверьте проектную <a href="/kalkulyatory/otdelka/gidroizolyaciya-vlagozaschita/">площадь гидроизоляции</a>, а при конденсате и сырости — <a href="/kalkulyatory/inzhenernye/ventilyaciya/">вентиляцию квартиры</a>. Площадь простой ванной можно получить здесь по размерам; ниши, короба, экран и разные высоты внесите как готовые площади из обмера.</p>
