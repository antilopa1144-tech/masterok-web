...
export const wallPanelsDef: CalculatorDefinition = {
  ...
  h1: "Калькулятор панелей для стен — пластиковые, древесноволокнистые и рельефные панели",
  description: "Рассчитайте количество пластиковых (ПВХ), древесноволокнистых (МДФ) или рельефных 3D-панелей, клея и плинтусов.",
  metaTitle: withSiteMetaTitle("Калькулятор панелей для стен: материалы онлайн"),
