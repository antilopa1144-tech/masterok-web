...
export const roofingDef: CalculatorDefinition = {
  ...
  metaTitle: withSiteMetaTitle("Калькулятор кровли: материалы по проекту"),
  metaDescription:
    "Бесплатный калькулятор кровли: рассчитайте покрытие, доборные элементы, мембрану, основание, пиломатериал и крепёж по проекту.",
  category: "roofing",
...
<h2>Как рассчитать площадь односкатной или двухскатной кровли</h2>
<p>Для простой односкатной или двухскатной крыши с одинаковым уклоном можно выбрать режим «проекция со свесами + уклон». Калькулятор применит S<sub>скатов</sub> = S<sub>проекции</sub> / cos(&alpha;). В горизонтальную проекцию уже должны входить карнизные и фронтонные свесы: площадь дома по стенам для этого не подходит.</p>
<p>Для вальмовой, мансардной, многощипцовой крыши, скатов с разными уклонами и сложных примыканий введите готовую сумму площадей из проекта или обмера. Калькулятор не строит чертёж, не определяет длины стропил и не заменяет геометрическую модель крыши.</p>
  ...
  <li>Разделите разные типоразмеры на отдельные расчёты и сверьте результат с раскладкой.</li>
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Для простой одно- или двухскатной крыши он переводит готовую горизонтальную проекцию со свесами в площадь скатов по одинаковому уклону. Вальмовая, мансардная, многощипцовая и другая сложная крыша требует суммы площадей из проекта или обмера: чертёж, стропильную геометрию и разные уклоны этот калькулятор не строит.",
      },
    ],
  },
};
