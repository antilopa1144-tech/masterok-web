...
export const sewageDef: CalculatorDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      defaultValue: 0,
      options: [
        { value: 0, label: "Из бетонных колец, типоразмер КС 10-9" },
        { value: 1, label: "Пластиковый заводской" },
        { value: 2, label: "Из еврокубов объёмом 1000 л" },
      ],
    },
    {
      key: "chambersCount",
  ...
  faq: [
    {
      ...
      answer:
        "Для постоянного проживания чаще выбирают 2 камеры; при большом расходе воды, нескольких санузлах и высоких требованиях к очистке — 3 камеры или локальное очистное сооружение. Высокий уровень грунтовых вод и слабая фильтрация грунта влияют на схему сильнее усреднённого правила.",
    },
    {
...
<p>Кольцо типоразмера КС 10-9: внутренний диаметр 1000 мм, высота 890 мм, объём <strong>~0.71 м&sup3;</strong>. На каждую камеру дополнительно нужны плита днища, плита перекрытия и полимерный люк.</p>
