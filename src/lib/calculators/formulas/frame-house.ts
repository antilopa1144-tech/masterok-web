...
faq: [
    {
      ...
      answer:
        "Часто 600 или 400 мм — под ширину утеплителя и раскрой листов (ОСБ, ЦСП, ГКЛ), чтобы снизить отходы. Окончательный шаг задаёт конструкция, нагрузки и облицовка; тяжёлый фасад может потребовать более частых стоек — это сверяют с проектом и СП 31-105-2002 / СП 64.",
    },
    {
