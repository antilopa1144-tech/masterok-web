  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 150, label: "150 мм (толстая ненесущая перегородка)" },
        { value: 200, label: "200 мм (только по проекту)" },
      ],
    },
    {
      key: "blockType",
...
- Газоблок и пеноблок 625×250: ~6,4 шт/м²
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Пеноблок D600</td><td>625&times;250&times;100</td><td>6.4</td><td>1.5 кг/м&sup2;</td></tr>
    <tr><td>ПГП (пазогребневые)</td><td>667&times;500&times;80</td><td>3.0</td><td>Гипсовый монтажный клей</td></tr>
  </tbody>
</table>
