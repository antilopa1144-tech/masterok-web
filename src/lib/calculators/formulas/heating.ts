...
export const heatingDef: CalculatorDefinition = {
  ...
  metaDescription: "Бесплатный калькулятор отопления: мощность по площади, количество секций биметаллических радиаторов, длина труб — расчёт для дома и квартиры.",
