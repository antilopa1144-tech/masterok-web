...
export const parquetDef: CalculatorDefinition = {
  ...
  description: "Рассчитайте количество паркетной доски, подложки и плинтуса с минимальным, рекомендуемым или повышенным запасом.",
  metaTitle: withSiteMetaTitle("Калькулятор паркетной доски: материалы онлайн"),
...
<ul>
  <li><strong>Подложка:</strong> пробка или экструдированный пенополистирол толщиной 2&ndash;3 мм, либо полиэтиленовая плёнка (плавающий монтаж)</li>
  ...
  <li><strong>Пароизоляция:</strong> полиэтиленовая плёнка толщиной 200 мкм на бетонное основание</li>
</ul>
...
`,
    faq: [
      ...
      {
        question: "Нужна ли подложка под паркетную доску?",
        answer: "<p>При <strong>плавающей укладке</strong> (замковое соединение) подложка обязательна. Она выполняет функции:</p><ul><li>Компенсация микронеровностей основания (до 2 мм)</li><li>Звукоизоляция &mdash; снижение ударного шума на 15&ndash;20 дБ</li><li>Пароизоляция (при наличии встроенного слоя)</li></ul><p>Типы подложки: пробка или экструдированный пенополистирол толщиной 2&ndash;3 мм, полиэтиленовая плёнка. При <strong>клеевой укладке</strong> подложка не используется &mdash; доска клеится непосредственно на основание.</p>",
      },
      {
