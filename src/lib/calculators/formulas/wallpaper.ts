...
export const wallpaperDef: CalculatorDefinition = {
  ...
  h1: "Калькулятор обоев на комнату — расчёт полотен и рулонов",
  description:
  ...
  metaTitle: withSiteMetaTitle(
    "Калькулятор обоев на комнату: расчёт рулонов",
  ),
  metaDescription:
    "Бесплатный калькулятор обоев на комнату: рассчитайте число полотен и рулонов по периметру, высоте, размеру рулона, раппорту и явному запасу.",
  category: "interior",
...
<h2>Поклейка обоев в квартире осенью и зимой</h2>
<p>Отопительный сезон сам по себе не подтверждает, что стены готовы к оклейке. Перед работой проверьте требования производителя обоев и клея к основанию, температуре, влажности, проветриванию и времени высыхания. Калькулятор считает полотна и рулоны, но не определяет влажность стены и не сокращает технологические выдержки из-за работающих батарей.</p>
<p>До раскроя завершите подготовку основания: при необходимости рассчитайте <a href="/kalkulyatory/otdelka/gruntovka/">грунтовку для стен</a> и <a href="/kalkulyatory/otdelka/shpaklevka/">шпаклёвку по площади</a>. Если при закрытых окнах появляется конденсат или сырость, проверьте <a href="/kalkulyatory/inzhenernye/ventilyaciya/">вентиляцию квартиры</a>, а сложные простенки и рисунок разложите в <a href="/instrumenty/raskladka-oboev/">инструменте раскладки обоев</a>.</p>
