  ...
  fields: [
    {
      ...
      hint: "Сначала выберите зону: от неё зависят форма, линейки в каталоге и сопутствующие материалы. Пол — экструдированный пенополистирол под стяжку или рулон между лагами; фасад — плиты минваты или пенополистирола.",
    },
    {
      key: "area",
    ...
    },
    {
      ...
      options: [
        ...
        { value: 1, label: "Центр — Москва, Санкт-Петербург, Поволжье" },
    ...
    },
    {
      ...
      options: [
        ...
        { value: 2, label: "2000×1000 мм (крупноформатный экструдированный пенополистирол)" },
        { value: 3, label: "1185×585 мм (экструдированный пенополистирол: Пеноплэкс, Технониколь XPS)" },
      ],
      hideIf: { key: "productId", op: "gt", value: 0 },
    },
    {
      ...
      hint: "Только для наружного фасада. Для пола, кровли, внутренних стен и цоколя система подставляется автоматически по полю «Что утепляем».",
    ...
    },
    {
      ...
      options: [
        ...
        { value: 4, label: "4 шт (минвата 150 мм / экструдированный пенополистирол 100 мм)" },
        { value: 5, label: "5 шт (пенопласт 100 мм)" },
        { value: 6, label: "6 шт (минвата 100 мм)" },
        { value: 8, label: "8 шт (экструдированный пенополистирол 50 мм)" },
        { value: 10, label: "10 шт (пенопласт 50 мм)" },
...
**Дюбели (только для штукатурного фасада):** минвата 7 шт/м², экструдированный пенополистирол 5, пенопласт 6 (+5% запас). Длина: толщина + 50 мм в основание.

**Сопутствующие материалы** зависят от назначения и системы монтажа:
| Материал                  | Мокрый штукатурный фасад | Каркас / вентилируемый фасад |
|---------------------------|----------------------|---------------------|
...
Для внутренних стен, кровли и пола калькулятор переключает каркасную систему автоматически.
  ...
  howToUse: [
    ...
    "Нажмите «Рассчитать» — список материалов зависит от выбранного типа: мокрый фасад, каркас или рулон",
  ],
faq: [
    {
    ...
    },
    {
      ...
      answer:
        "В расчёте заложены нормы спецификации: минвата 7 шт/м², экструдированный пенополистирол 5, пенопласт 6; эковату дюбелями не крепят. Дополнительно учтён запас. Углы, кромки и проёмы на объекте усиливают по схеме выбранной фасадной системы.",
    },
  ],
  seoContent: {
    descriptionHtml: `
...
<p>Количество тарельчатых дюбелей (только для мокрого штукатурного фасада):</p>
    ...
    faq: [
      {
        ...
        answer: "<p>Для минваты 1200&times;600 мм (0.72 м&sup2;/плита) при запасе 5%: &lceil;105 / 0.72&rceil; = <strong>146 плит</strong> (округление до упаковок — в калькуляторе).</p><p>Тарельчатые дюбели для мокрого фасада: &lceil;100 &times; 7 &times; 1,05&rceil; = <strong>735 штук</strong>, длина 150 мм при слое 100 мм.</p>",
      },
      {
