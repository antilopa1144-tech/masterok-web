...
export const decorStoneDef: CalculatorDefinition = {
  ...
  metaTitle: withSiteMetaTitle("Калькулятор декоративного камня: материалы онлайн"),
  ...
  faq: [
    {
      ...
      answer:
        "По типу камня: гипсовый — гипсовый/цементный клей (~3 кг/м²), цементный — усиленный плиточный (~5 кг/м²), тяжёлый натуральный — повышенной фиксации (до ~7 кг/м²). Для надёжности часто делают двустороннее нанесение (на стену и на камень).",
    },
    {
      question: "Нужна ли расшивка швов при укладке декоративного камня?",
      answer:
        "Зависит от дизайна: под «кирпич» обычно шов 8–12 мм с затиркой, при бесшовной укладке — вплотную. Шов улучшает вид и защищает торцы, но увеличивает расход и время работ.",
    },
  ],
  seoContent: {
    descriptionHtml: `
