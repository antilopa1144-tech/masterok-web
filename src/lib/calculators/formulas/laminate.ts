...
**Лента для стыков подложки** добавляется только для рулонных подложек. У подложки-«гармошки» из вспененного полистирола стыки обычно самоклеящиеся.
...
`,
    faq: [
      ...
      },
      {
        ...
        answer: "<p>Типы подложки и их характеристики:</p><table><thead><tr><th>Материал</th><th>Толщина</th><th>Особенности</th></tr></thead><tbody><tr><td>Вспененный полиэтилен</td><td>2&ndash;3 мм</td><td>Бюджетный вариант, быстро продавливается</td></tr><tr><td>Экструдированный пенополистирол</td><td>2&ndash;5 мм</td><td>Хорошая звукоизоляция, долговечность</td></tr><tr><td>Пробка</td><td>2&ndash;4 мм</td><td>Натуральная, отличная звукоизоляция</td></tr><tr><td>Хвойная древесноволокнистая плита</td><td>3&ndash;7 мм</td><td>Выравнивание до 3 мм перепада</td></tr></tbody></table><p>На бетонное основание дополнительно стелят <strong>пароизоляционную полиэтиленовую плёнку толщиной 200 мкм</strong>. По <strong>ГОСТ 32304-2013</strong> общая толщина подложки не должна превышать рекомендации производителя.</p>",
      },
      {
