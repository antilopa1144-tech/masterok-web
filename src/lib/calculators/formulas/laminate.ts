...
export const laminateDef: CalculatorDefinition = {
  ...
  metaTitle: withSiteMetaTitle("Калькулятор ламината по площади: упаковки и подложка"),
...
<h2>Укладка ламината в квартире осенью и зимой</h2>
<p>Работающее отопление не подтверждает, что стяжка или другое основание готовы к укладке. Условия хранения и акклиматизации упаковок, допустимые температуру и влажность, требования к основанию и совместимость с тёплым полом проверяйте по инструкции конкретной коллекции. Калькулятор определяет закупку, но не измеряет влажность, ровность и прочность основания.</p>
<p>Если площадь ещё не снята, используйте <a href="/instrumenty/ploshchad-komnaty/">инструмент площади комнаты</a>; стыки и крайние подрезки проверьте в <a href="/instrumenty/raskladka-laminata/">раскладке ламината</a>. При конденсате и устойчивой сырости в квартире до укладки проверьте <a href="/kalkulyatory/inzhenernye/ventilyaciya/">вентиляцию и воздухообмен</a>.</p>
`,
    faq: [
      {
