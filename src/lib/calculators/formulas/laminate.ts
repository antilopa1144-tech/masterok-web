...
**Компенсационный профиль** при площади более 50 м² — предварительная позиция текущей модели длиной √S. Одна площадь не задаёт необходимость и расположение швов: нужны длина и ширина помещения, переходы и ограничения изготовителя покрытия.
  ...
  seoContent: {
    descriptionHtml: `
<h2>Как рассчитать ламинат по площади комнаты</h2>
<ol>
  <li>Если известна площадь пола в м², выберите способ ввода <strong>«По площади»</strong>. Для прямоугольной комнаты можно оставить <strong>«По размерам комнаты»</strong> и ввести длину и ширину.</li>
  <li>Укажите <strong>площадь упаковки</strong> выбранной коллекции: нужна площадь всей пачки, а не одной доски. Проверьте значение на этикетке материала.</li>
  <li>Выберите способ укладки и явный запас, затем нажмите <strong>«Рассчитать»</strong>. Проверьте число целых упаковок к покупке и пояснения к выбранному режиму расчёта.</li>
</ol>
<p>Если площадь ещё неизвестна, начните с <a href="/instrumenty/ploshchad-komnaty/">расчёта площади комнаты</a>. Для плинтуса одного числа в м² недостаточно: в режиме «По площади» отдельно заполните «Фактический периметр» по подсказке поля. При нулевом значении используется предварительная оценка, а не обмер стен.</p>
<p>Количество упаковок и схема отдельных досок — разные результаты. Чтобы посмотреть стыки и подрезки, откройте <a href="/instrumenty/raskladka-laminata/">раскладку ламината со схемой</a> и проверьте размеры комнаты и доски. Одна площадь не определяет форму помещения.</p>
...
<p>Перед покупкой прочитайте, <a href="/blog/kak-vybrat-podlozhku-pod-laminat/">как выбрать подложку под ламинат</a>: что проверить по основанию, толщине и тёплому полу, а затем как перевести площадь в целые упаковки или погонные метры.</p>
`,
    faq: [
      {
        question: "Как рассчитать ламинат, если известна только площадь комнаты?",
        answer: "<p>Выберите «По площади», введите площадь пола в м² и площадь целой упаковки с этикетки ламината. Затем проверьте способ укладки, явный запас и режим расчёта. Для плинтуса отдельно укажите фактический периметр по подсказке поля: площадь пола не задаёт длину всех стен.</p>",
      },
      {
        question: "Этот калькулятор показывает схему укладки ламината?",
        answer: "<p>Здесь рассчитываются упаковки и сопутствующие материалы. Схема отдельных досок открывается в отдельном инструменте по ссылке «Увидеть раскладку 1/3, 1/2 или ёлочкой». Проверьте там размеры комнаты и доски: по одной площади нельзя восстановить форму помещения и расположение подрезок.</p>",
      },
      {
        question: "Сколько упаковок ламината нужно на комнату 20 м2?",
        answer: "<p>При упаковке 2,397 м², прямой укладке и явном запасе 10% базовая геометрия даёт 20 × 1,10 = <strong>22 м²</strong>, затем ⌈22 / 2,397⌉ = <strong>10 базовых упаковок</strong>. В дефолтном режиме «Реальный» к потребности применяются сценарные поправки, поэтому итоговая карточка показывает <strong>11 упаковок</strong>. Для диагонали и сложного контура сверяйтесь с выбранным режимом и раскладкой по размерам доски.</p>",
      },
      {
