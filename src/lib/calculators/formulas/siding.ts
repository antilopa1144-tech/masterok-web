...
<h2>Связанные расчёты фасада</h2>
<p>Если в принятой конструкции есть теплоизоляция, сначала проверьте количество плит и упаковок в <a href="/kalkulyatory/fasad/uteplenie/">калькуляторе утеплителя</a>. Для предварительной ведомости панелей, профиля, углов и стартовых элементов по геометрии дома используйте <a href="/kalkulyatory/fasad/fasadnye-paneli/">калькулятор фасадных панелей</a>. Оба расчёта требуют параметров выбранной системы и не определяют проектный узел автоматически.</p>
`,
    faq: [
      {
