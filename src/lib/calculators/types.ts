...
export interface Category {
  ...
  seoSubject: string;
  /**
   * Готовое meta description для страницы категории.
   *
   * Отдельное поле, а не `description`: тот выводится подзаголовком в шапке
   * категории и должен оставаться коротким. Шаблон «Бесплатные калькуляторы: X.
   * Расход материалов…» давал 107–118 символов — ниже комфортного диапазона
   * выдачи, но удлинять видимый подзаголовок ради метатега нельзя.
   */
