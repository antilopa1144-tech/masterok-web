...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "description": "Рассчитайте одну или две позиции шпаклёвки по площади, паспортному расходу, фактической толщине или числу проходов и упаковке выбранного продукта.",
    "metaTitle": "Калькулятор шпаклёвки: расход по техкарте",
    "metaDescription": "Бесплатный калькулятор шпаклёвки: рассчитайте потребность по площади и расходу из техкарты, затем округлите закупку по фактической упаковке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "шпаклёвка",
