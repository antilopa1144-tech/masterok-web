...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор плитного фундамента: материалы онлайн",
    "metaDescription": "Бесплатный калькулятор плитного фундамента: рассчитайте бетон, две арматурные сетки, опалубку, песок, щебень, геотекстиль и ЭППС.",
    "category": "foundation",
    "categorySlug": "fundament",
    "tags": [
      "плитный фундамент",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор цокольного этажа и подвала: бетон, арматура",
  ...
  },
  {
    ...
    "description": "Рассчитайте арматуру для плитного и ленточного фундамента, армопояса или перекрытия: метраж, вес, стержни 11,7 м, вязальную проволоку и фиксаторы.",
    "metaTitle": "Калькулятор арматуры: вес и вязальная проволока",
    "metaDescription": "Бесплатный калькулятор арматуры: рассчитайте для плиты, ленты или армопояса общий метраж и вес, число стержней 11,7 м, вязальную проволоку и фиксаторы.",
    "category": "foundation",
    "categorySlug": "fundament",
    "tags": [
      "арматура",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор каркасного дома: материалы онлайн",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор фасадных панелей: материалы онлайн",
