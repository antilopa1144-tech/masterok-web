...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор арматуры и вязальной проволоки",
    "metaDescription": "Бесплатный калькулятор арматуры: рассчитайте количество на фундамент, общий метраж и вес, число стержней 11,7 м, вязальную проволоку и фиксаторы.",
    "category": "foundation",
    "categorySlug": "fundament",
    "tags": [
      "арматура",
