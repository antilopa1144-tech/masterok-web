...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "description": "Рассчитайте плитку для пола и стен ванной по обмеру или готовым площадям, с отдельным явным запасом и фасовкой каждой позиции.",
    "metaTitle": "Калькулятор плитки для ванной: пол, стены, коробки",
    "metaDescription": "Бесплатный калькулятор плитки для ванной: рассчитайте площадь пола и стен, количество плиток и коробок по фактической фасовке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "ванная",
