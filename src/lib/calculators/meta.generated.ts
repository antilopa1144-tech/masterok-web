...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "description": "Рассчитайте одну однородную позицию грунтовки по готовой площади или простой геометрии комнаты, паспортному расходу, числу слоёв и фактической упаковке.",
    "metaTitle": "Калькулятор грунтовки: расход по техкарте и упаковка",
    "metaDescription": "Бесплатный калькулятор грунтовки: рассчитайте потребность по площади, расходу из техкарты и слоям, затем округлите закупку по фактической упаковке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "грунтовка",
