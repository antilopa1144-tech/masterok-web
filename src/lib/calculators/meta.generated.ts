...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "metaDescription": "Бесплатный калькулятор обоев: число полотен, выход из рулона и итог к покупке по периметру, высоте, размеру рулона, раппорту и явному запасу.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "калькулятор обоев",
