...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "metaDescription": "Бесплатный калькулятор арматуры: рассчитайте сетку или каркас, чистый метраж, массу, проволоку и целые прутки к покупке.",
    "category": "foundation",
    "categorySlug": "fundament",
    "tags": [
      "арматура",
  ...
  },
  {
    ...
    "metaDescription": "Бесплатный калькулятор кладки кирпича: предварительно рассчитайте кирпич и раствор для стены. Сетка и перемычки справочны; итог сверяйте с проектом.",
    "category": "walls",
    "categorySlug": "steny",
    "tags": [
      "кирпич",
  ...
  },
  {
    ...
    "h1": "Калькулятор ламината по площади — упаковки, подложка и плинтус",
    "description": "Рассчитайте количество упаковок ламината, подложки и плинтуса по размерам комнаты или готовой площади, способу укладки и явному запасу.",
    "metaTitle": "Калькулятор ламината по площади: упаковки и подложка",
    "metaDescription": "Бесплатный калькулятор ламината по площади: рассчитайте упаковки, подложку, плинтус и порожки по размерам комнаты и явному запасу.",
    "category": "flooring",
    "categorySlug": "poly",
    "tags": [
      "ламинат",
  ...
  },
  {
    ...
    "metaDescription": "Бесплатный калькулятор стяжки: рассчитайте цемент и песок, пескобетон или полусухую стяжку по площади и полной толщине, в том числе над тёплым полом.",
    "category": "flooring",
    "categorySlug": "poly",
    "tags": [
      "стяжка",
  ...
  },
  {
    ...
    "description": "Рассчитайте рейки для простой прямоугольной раскладки или перенесите готовую ведомость, затем добавьте только подтверждённые системой профили и крепёж.",
    "metaTitle": "Калькулятор реечного потолка: рейки и профили",
    "metaDescription": "Бесплатный калькулятор реечного потолка: рассчитайте ряды и рейки по модулю системы или проверьте проектную ведомость, упаковки и остаток.",
    "category": "ceiling",
    "categorySlug": "potolki",
    "tags": [
      "реечный потолок",
  ...
  },
  {
    ...
    "description": "Рассчитайте кассеты по фактическому модулю простой сетки или перенесите готовую ведомость, затем добавьте только подтверждённые системой профили и подвесы.",
    "metaTitle": "Калькулятор кассетного потолка: раскладка и закупка",
    "metaDescription": "Бесплатный калькулятор кассетного потолка: рассчитайте модульную сетку, симметричные крайние подрезки, упаковки и подтверждённые проектом комплектующие.",
    "category": "ceiling",
    "categorySlug": "potolki",
    "tags": [
      "кассетный потолок",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор утепления потолка в квартире и доме",
  ...
  },
  {
    ...
    "metaDescription": "Бесплатный калькулятор кровли: рассчитайте покрытие, доборные элементы, мембрану, основание, пиломатериал и крепёж по проекту.",
    "category": "roofing",
  ...
  },
  {
    ...
    "h1": "Калькулятор утеплителя для дома и квартиры",
    "description": "Рассчитайте закупку минваты, пеноплекса или пенопласта для стен, лоджии, кровли, потолка и пола по площади, толщине и упаковке.",
    "metaTitle": "Калькулятор утеплителя для дома и квартиры",
    "metaDescription": "Бесплатный калькулятор утеплителя для дома и квартиры: рассчитайте минвату, пеноплекс и пенопласт для стен, лоджии, кровли и пола по площади и упаковке.",
    "category": "facade",
    "categorySlug": "fasad",
    "tags": [
      "утеплитель",
  ...
  },
  {
    ...
    "description": "Рассчитайте террасную доску из ДПК или дерева по направлению рядов, фактической рабочей ширине, зазору, длине товара, явному запасу и фасовке. Лаги, крепёж и подготовку добавляйте только по проектной ведомости.",
    "metaTitle": "Калькулятор террасной доски и ДПК: расчёт",
    "metaDescription": "Бесплатный калькулятор террасной доски и ДПК: рассчитайте ряды, раскрой, запас и пачки по фактическому профилю; лаги и крепёж — по проектным данным.",
    "category": "facade",
    "categorySlug": "fasad",
    "tags": [
      "террасная доска",
  ...
  },
  {
    ...
    "description": "Рассчитайте одну позицию газона: семена по норме и фасовке выбранной смеси либо рулоны по фактической площади и явному запасу.",
    "metaTitle": "Калькулятор газона: семена и рулоны к покупке",
    "metaDescription": "Бесплатный калькулятор газона: рассчитайте семена по норме с упаковки или рулонный газон по площади рулона, запасу и целым упаковкам.",
    "category": "facade",
    "categorySlug": "fasad",
    "tags": [
      "газон",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор радиаторов для квартиры и дома",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор вентиляции квартиры и дома",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор водяного тёплого пола: длина трубы и контуры",
  ...
  },
  {
    ...
    "description": "Оцените минимальный рабочий объём септика по суточному притоку или проверьте выбранную систему, камеры и проектную трассу без скрытых материалов.",
    "metaTitle": "Калькулятор септика: объём и проверка",
    "metaDescription": "Бесплатный калькулятор септика: рассчитайте минимальный рабочий объём по суточному притоку, проверьте число камер и выбранную систему без подбора конструкции.",
    "category": "engineering",
    "categorySlug": "inzhenernye",
    "tags": [
      "септик",
  ...
  },
  {
    ...
    "description": "Рассчитайте число целых полотен и рулонов по периметру, параметрам выбранного артикула и способу совмещения рисунка или перенесите готовый итог из карты раскроя.",
    "metaTitle": "Калькулятор обоев на комнату: расчёт рулонов",
    "metaDescription": "Бесплатный калькулятор обоев на комнату: рассчитайте число полотен и рулонов по периметру, высоте, размеру рулона, раппорту и явному запасу.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "калькулятор обоев",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор краски для стен: литры и банки",
  ...
  },
  {
    ...
    "description": "Рассчитайте расход грунтовки для стен, потолка или пола по площади, норме производителя, числу слоёв и фактической фасовке.",
    "metaTitle": "Калькулятор грунтовки для стен: расход на 1 м²",
    "metaDescription": "Бесплатный калькулятор грунтовки для стен: рассчитайте расход на 1 м² по площади, норме производителя и числу слоёв, получите упаковки и остаток.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "грунтовка",
  ...
  },
  {
    ...
    "description": "Рассчитайте шпаклёвку для стен и потолка по площади, расходу из техкарты, фактической толщине или числу проходов и фасовке выбранного продукта.",
    "metaTitle": "Калькулятор шпаклёвки для стен по площади",
    "metaDescription": "Бесплатный калькулятор шпаклёвки для стен и потолка: рассчитайте расход по площади и техкарте, толщине или проходам, получите целые упаковки.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "шпаклёвка",
  ...
  },
  {
    ...
    "description": "Рассчитайте гидроизоляционный состав по фактической площади покрытия, расходу конкретного продукта, явной надбавке и фасовке.",
    "metaTitle": "Калькулятор гидроизоляции: расход по техкарте",
    "metaDescription": "Бесплатный калькулятор гидроизоляции: рассчитайте расход состава по площади и техкарте, явную надбавку и количество упаковок к покупке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "гидроизоляция",
  ...
  },
  {
    ...
    "description": "Рассчитайте монтажную пену, наличник или добор либо крепёж по явной норме, фактическому обмеру и фасовке выбранного товара.",
    "metaTitle": "Калькулятор установки дверей: пена, погонаж, крепёж",
    "metaDescription": "Бесплатный калькулятор материалов для установки дверей: рассчитайте пену по расходу, наличник и добор по обмеру, крепёж по схеме и фактической упаковке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "установка дверей",
  ...
  },
  {
    ...
    "description": "Рассчитайте, сколько монтажной пены нужно для установки окон по размерам блока, ширине и глубине шва и полезному выходу выбранного баллона.",
    "metaTitle": "Калькулятор установки окон и монтажной пены",
    "metaDescription": "Бесплатный калькулятор установки окон: рассчитайте, сколько монтажной пены нужно по размерам блока и шва, а откосы и ленты — по проектным данным.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "монтаж окон",
  ...
  },
  {
    ...
    "description": "Рассчитайте площадь оконных или дверных откосов и переведите её в одну выбранную закупку: листы, смесь либо профиль по фактической фасовке.",
    "metaTitle": "Калькулятор откосов: площадь и материалы",
    "metaDescription": "Бесплатный калькулятор откосов окон и дверей: рассчитайте площадь по реальным размерам, листы, смесь или профиль с явным запасом и фасовкой товара.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "калькулятор откосов",
  ...
  },
  {
    ...
    "description": "Посчитайте площадь стен и потолка балкона с вычетом окон и двери, затем рассчитайте одну позицию вагонки или панелей до целых упаковок.",
    "metaTitle": "Калькулятор площади и обшивки балкона",
    "metaDescription": "Бесплатный калькулятор площади и обшивки балкона: рассчитайте стены и потолок с вычетом проёмов, затем вагонку или панели по размерам и фасовке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "обшивка балкона",
  ...
  },
  {
    ...
    "description": "Рассчитайте площадь пола и стен ванной, затем количество плитки и коробок по обмеру, размерам выбранных артикулов, запасу и фасовке.",
    "metaTitle": "Калькулятор ванной комнаты: площадь стен и плитка",
    "metaDescription": "Бесплатный калькулятор ванной комнаты: рассчитайте площадь пола и стен с вычетом проёмов, количество плитки и коробок по фактической фасовке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "ванная",
  ...
  },
  {
    ...
    "description": "Рассчитайте количество одной однородной позиции крепежа по готовой ведомости, подтверждённой норме на площадь или явному шагу повторяющихся линий.",
    "metaTitle": "Калькулятор крепежа: точки, шаг и упаковки",
    "metaDescription": "Бесплатный калькулятор крепежа: рассчитайте готовое число точек по проектной норме или шагу линий, явный запас и закупку по фактической упаковке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "крепёж",
