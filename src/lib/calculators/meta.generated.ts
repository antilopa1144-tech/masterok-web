...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "description": "Рассчитайте по размерам или площади листы ГКЛ, профили ПП и ПН, подвесы, соединители и крепёж к покупке.",
    "metaTitle": "Калькулятор гипсокартона на потолок: ГКЛ и профиль",
    "metaDescription": "Бесплатный калькулятор гипсокартона на потолок: рассчитайте по размерам или площади листы ГКЛ, профиль, подвесы, крепёж и материалы к покупке.",
    "category": "ceiling",
    "categorySlug": "potolki",
    "tags": [
      "подвесной потолок",
  ...
  },
  {
    ...
    "metaTitle": "Калькулятор вентиляции: расчёт материалов онлайн",
