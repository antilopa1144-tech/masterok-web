...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "description": "Рассчитайте одну позицию вагонки или панелей для балкона по чистой площади, простому обмеру либо готовому числу деталей из раскладки.",
    "metaTitle": "Калькулятор обшивки балкона: панели и вагонка",
    "metaDescription": "Бесплатный калькулятор обшивки балкона: рассчитайте вагонку или панели по чистой площади, рабочей ширине, длине, запасу и фасовке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "обшивка балкона",
