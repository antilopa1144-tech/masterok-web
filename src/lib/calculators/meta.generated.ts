...
export const ALL_CALCULATORS_META: CalculatorMeta[] = [
  ...
  },
  {
    ...
    "metaDescription": "Бесплатный калькулятор крепежа: готовое число точек, расчёт по проектной норме или шагу линий, явный запас и округление по фактической упаковке.",
    "category": "interior",
    "categorySlug": "otdelka",
    "tags": [
      "крепёж",
