...
export const PACKAGE_UNIT_FORMS: Record<string, [string, string, string]> = {
  ...
  "поддонов": ["поддон", "поддона", "поддонов"],
  "баллонов": ["баллон", "баллона", "баллонов"],
  "модулей":  ["модуль", "модуля", "модулей"],
  "комплектов": ["комплект", "комплекта", "комплектов"],
  "секций":   ["секция", "секции", "секций"],
  "отрезков": ["отрезок", "отрезка", "отрезков"],
  "профилей": ["профиль", "профиля", "профилей"],
  "пачек":    ["пачка", "пачки", "пачек"],
  "реек":     ["рейка", "рейки", "реек"],
