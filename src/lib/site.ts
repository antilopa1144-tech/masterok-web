...
// Точное число вместо «65+»: в каталоге ровно 65 калькуляторов, и завышение
// на единицу видно и в сниппете, и в карточке соцсети.
...
export const SITE_FOOTER_DESCRIPTION = `${SITE_WEBPAGE_DESCRIPTION}. Нормы расхода, практический запас и итог к покупке.`;
