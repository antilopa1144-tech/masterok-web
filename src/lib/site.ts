...
export const SITE_METADATA_DESCRIPTION =
  "Бесплатные строительные калькуляторы онлайн: бетон, кирпич, кровля, ламинат, плитка, гипсокартон и ещё 60+ расчётов. Точно, быстро, по ГОСТ.";
export const SITE_TWITTER_TITLE = `${SITE_NAME} — строительные калькуляторы`;
export const SITE_TWITTER_DESCRIPTION = "60+ бесплатных строительных калькуляторов онлайн";
export const SITE_OG_DESCRIPTION = "60+ бесплатных строительных калькуляторов. Точный расчёт материалов по ГОСТ.";
