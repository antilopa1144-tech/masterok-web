...
export const SITE_TWITTER_DESCRIPTION = "50+ бесплатных строительных калькуляторов онлайн";
export const SITE_OG_DESCRIPTION = "50+ бесплатных строительных калькуляторов. Точный расчёт материалов по ГОСТ.";
