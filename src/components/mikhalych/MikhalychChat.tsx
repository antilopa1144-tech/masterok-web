  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Я Михалыч — AI-помощник по ремонту. Запускаю калькуляторы Мастерок, сравниваю варианты и готовлю расчёты, которые можно добавить в смету проекта. Опишите задачу и известные размеры обычными словами.",
    },
  ]);
