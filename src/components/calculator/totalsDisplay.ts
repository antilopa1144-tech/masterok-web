export const TOTAL_LABELS: Record<string, string> = {
  ...
  layoutAreaM2: "Фактическая площадь раскладки",
  pipeSpacingMm: "Шаг трубы из проекта",
  fieldPipeLengthM: "Труба в площади раскладки",
  connectionLengthM: "Подводки вне раскладки",
  projectTotalPipeLengthM: "Длина контуров по ведомости",
  exactPipeLengthM: "Точная потребность в трубе",
  circuitCount: "Контуров по ведомости",
  averageCircuitLengthM: "Средняя длина контура",
  longestCircuitLengthM: "Самый длинный контур",
  maxCircuitLengthM: "Проектный предел контура",
  coilLengthM: "Длина выбранной бухты",
  requiredCoilCount: "Бухт к покупке",
  leftoverPipeLengthM: "Остаток после округления",
  collectorCount: "Коллекторов по ведомости",
  manifoldOutletCount: "Выходов коллекторов",
  // Электрика
  ...
  equivalentResidents: "Эквивалентное число жителей",
  wastewaterPerResidentL: "Сток на одного ЭЧЖ",
  projectDailyFlowM3: "Суточный приток из проекта",
  dailyFlowM3: "Расчётный суточный приток",
  retentionMultiplier: "Коэффициент минимального объёма",
  minimumWorkingVolumeM3: "Минимальный рабочий объём",
  selectedWorkingVolumeM3: "Рабочий объём выбранной системы",
  verifiedWorkingVolumeM3: "Объём для проверки",
  volumeShortfallM3: "Дефицит рабочего объёма",
  volumeMarginM3: "Превышение над минимумом",
  minimumChamberCount: "Минимум камер",
  selectedChamberCount: "Камер в выбранной системе",
  naturalTreatmentStatus: "Статус последующей очистки",
  groundwaterStatus: "Статус сезонного УГВ",
  pipeLengthM: "Труба по проектной трассе",
  pipeSectionLengthM: "Длина товарного отрезка",
  pipeSections: "Товарных отрезков трубы",
  purchasePipeLengthM: "Трубы к покупке",
  pipeLeftoverM: "Остаток трубы",
  inspectionWellCount: "Смотровых колодцев",
  fittingCount: "Фасонных частей",
  // Разное
...
export const TOTAL_UNITS: Record<string, string> = {
  ...
  // Тёплый пол
  totalPipe: "м", layoutAreaM2: "м²", pipeSpacingMm: "мм",
  fieldPipeLengthM: "м", connectionLengthM: "м", projectTotalPipeLengthM: "м",
  exactPipeLengthM: "м", averageCircuitLengthM: "м", longestCircuitLengthM: "м",
  maxCircuitLengthM: "м", coilLengthM: "м", purchasePipeLengthM: "м",
  leftoverPipeLengthM: "м",
  // Канализация
  totalVolumeM3: "м³", equivalentResidents: "ЭЧЖ",
  wastewaterPerResidentL: "л/сут", projectDailyFlowM3: "м³/сут",
  dailyFlowM3: "м³/сут", retentionMultiplier: "×",
  minimumWorkingVolumeM3: "м³", selectedWorkingVolumeM3: "м³",
  verifiedWorkingVolumeM3: "м³", volumeShortfallM3: "м³", volumeMarginM3: "м³",
  pipeLengthM: "м", pipeSectionLengthM: "м", pipeLeftoverM: "м",
  // Ламинат/паркет
  packArea: "м²",
  // Разное
...
export const INTEGER_TOTAL_KEYS = new Set([
  ...
  "circuits", "circuitCount", "requiredCoilCount", "collectorCount", "manifoldOutletCount",
  "equivalentResidents", "minimumChamberCount", "selectedChamberCount",
  "naturalTreatmentStatus", "groundwaterStatus", "pipeSections", "inspectionWellCount", "fittingCount",
...
export const TOTAL_LABEL_FORMS: Record<string, [string, string, string]> = {
  ...
  minimumChamberCount: ["Минимум: камера", "Минимум: камеры", "Минимум: камер"],
  selectedChamberCount: ["Камера в системе", "Камеры в системе", "Камер в системе"],
  pipeSections: ["Товарный отрезок трубы", "Товарных отрезка трубы", "Товарных отрезков трубы"],
  inspectionWellCount: ["Смотровой колодец", "Смотровых колодца", "Смотровых колодцев"],
  fittingCount: ["Фасонная часть", "Фасонные части", "Фасонных частей"],
  circuits: ["Контур", "Контура", "Контуров"],
  circuitCount: ["Контур по ведомости", "Контура по ведомости", "Контуров по ведомости"],
  requiredCoilCount: ["Бухта к покупке", "Бухты к покупке", "Бухт к покупке"],
  collectorCount: ["Коллектор по ведомости", "Коллектора по ведомости", "Коллекторов по ведомости"],
  manifoldOutletCount: ["Выход коллектора", "Выхода коллекторов", "Выходов коллекторов"],
