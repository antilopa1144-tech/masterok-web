...
export const MIKHALYCH_WIDGET_UI_TEXT = {
  ...
  greetingWithContext: (calculatorTitle: string) =>
    `Вижу ваш расчёт по **${calculatorTitle}** — цифры на месте. Спрашивайте что угодно: хватит ли материала, что докупить, где обычно косячат.`,
  greetingWithoutContext: (calculatorTitle: string) =>
    `По **${calculatorTitle}** спрашивайте свободно — технология, расход, типичные ошибки. Сначала отвечу по сути, без лекций.`,
