...
![3D-интерьер двух комнат с выделенной зоной дверного проёма](./images/doorway-plan-3d.webp)

*Тонкая акцентная линия показывает место, которое проверяют до раскладки. Это 3D-иллюстрация без масштаба, а не указание ширины шва или способа монтажа.*
...
![3D-план квартиры с коридором, спальней и гостиной](./images/apartment-plan-3d.webp)

*3D-план помогает увидеть каждый проём как отдельную точку решения. Медные линии выделяют зоны проверки, а не готовые монтажные решения.*
...
![Два интерьерных сценария перехода пола в дверном проёме](./images/profile-types-3d.webp)

*Слева и справа — два интерьерных сценария перехода. Иллюстрация помогает заметить разницу задач, но не задаёт профиль, способ крепления или допустимый перепад.*
