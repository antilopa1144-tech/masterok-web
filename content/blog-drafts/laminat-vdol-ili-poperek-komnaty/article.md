...
![Одна и та же гостиная с досками в двух направлениях](./images/directions-3d.webp)

*Один интерьер показан в двух вариантах: меняется только направление досок. Это 3D-иллюстрация для сравнения восприятия, а не монтажная раскладка.*
...
![3D-гостиная с точками, из которых обычно смотрят на пол](./images/viewpoints-3d.webp)

*3D-визуал напоминает оценить пол от входа, дивана и рабочего места. Световые конусы показывают направление взгляда, не направление монтажа.*
...
![3D-сравнение двух поворотов досок в одной комнате](./images/cuts-comparison-3d.webp)

*Одна комната показана в двух поворотах покрытия. Это визуальная подсказка перед расчётом, а не схема раскроя и не расчёт количества досок.*
...
Пять минут такой проверки экономят часы переделок позже: выбранные пачки, образец и план комнаты не придётся пересобирать из-за одного неверно понятого направления.
