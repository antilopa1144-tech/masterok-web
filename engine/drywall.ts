  ...
  return [
    {
      name: sheetName,
      subtitle: isCeiling
        ? "Модель считает лист 12,5 мм с базовым запасом 10%; тип листа, раскрой и число слоёв сверяйте с выбранной потолочной системой"
        : "Модель считает лист 12,5 мм с базовым запасом 10%; тип плиты, раскрой и допустимое число слоёв сверяйте с выбранной системой",
    ...
    },
    {
      ...
      subtitle: isPartition
        ? "Предварительная пара ПН 50×40/ПС 50×50; длина направляющих +5%, затем округление до хлыстов 3 м. Сечение и крепление выбирают по системе"
        : "Предварительная пара ПН 27×28/ПП 60×27; периметр каждой стены +5%, затем округление до хлыстов 3 м. Схему каркаса выбирают по системе",
      quantity: pnPieces,
      unit: "шт",
    ...
    },
    {
      ...
      subtitle: isPartition
        ? "Стойки по выбранному шагу 400/600 мм с крайними стойками на каждом участке; длина +5%, затем округление до хлыстов 3 м"
        : "Профили по выбранному шагу 400/600 мм с крайними стойками на каждом участке; длина +5%. Подвесы модель не считает",
      quantity: ppPieces,
      unit: "шт",
    ...
    screwMaterial(
      ...
      screwsTfPackagePcs,
      screws35Pcs > 0
        ? "Первый слой: 30 шт/м² обшивки +5%, упаковка 200 шт.; шаг и тип крепежа сверяйте с системой"
        : "30 шт/м² обшивки +5%, упаковка 200 шт.; шаг и тип крепежа сверяйте с системой",
    ),
    ...(screws35Pcs > 0
      ? [screwMaterial(
          ...
          screws35Pcs,
          screwsTfPackagePcs,
          "Для второго слоя: 30 шт/м² обшивки +5%, упаковка 200 шт.; длину и схему крепления сверяйте с системой",
        )]
      : []),
    screwMaterial(
      ...
      screwsLbPcs,
      screwsLbPackagePcs,
      "По 4 шт. на рассчитанную стойку +5%, упаковка 100 шт.; фактические соединители зависят от узлов каркаса",
    ),
    {
      name: "Дюбель-гвозди 6×40 мм",
      subtitle: "По периметру направляющих с условным шагом 0,6 м; тип, длину и допустимый шаг крепежа выбирают по основанию и системе",
      quantity: dowels,
      unit: "шт",
      withReserve: dowels,
      purchaseQty: dowels,
    ...
    },
    {
      ...
      subtitle: "По рассчитанному периметру направляющих без запаса, округление вверх до рулонов 30 м; ширину и узлы примыканий сверяйте с системой",
    ...
    },
    {
      ...
      subtitle: "Предварительная модель: 0,8 кг/м² площади всех слоёв +15%, мешок 25 кг; фактический расход берите из техкарты состава и схемы швов",
    ...
    },
    {
      ...
      subtitle: "Предварительная модель: 1,0 кг/м² площади всех слоёв +15%, мешок 25 кг; уровень подготовки и расход задаёт выбранная система отделки",
    ...
    {
      name: "Серпянка 90м",
      subtitle: "Условно 2,5 м на рассчитанный лист +10%, рулон 90 м; тип ленты и реальную длину определяют раскладка и технология заделки швов",
    ...
    {
      ...primerMat,
      subtitle: "Предварительная модель: 0,3 л/м² площади всех слоёв +15%; основание, число проходов и фасовку сверяйте с продуктом",
      category: "Отделка",
    },
    {
      name: "Наждачная бумага P180",
      subtitle: "Условно 1 лист на 5 м² площади всех слоёв, упаковка 10 шт.; зернистость и расход зависят от системы отделки",
...
export function computeCanonicalDrywall(
  ...
  if (height > spec.warnings_rules.wide_profile_height_threshold) {
    warnings.push("Высота более 3,5 м выходит за упрощённую модель: ведомость всё ещё считает фиксированные ПС 50×50 мм. Сечение, шаг, число слоёв и узлы каркаса нужно выбрать по проекту или альбому комплектной системы");
  }
  if (layers === 2) {
    warnings.push("Для двухслойной обшивки раскладку листов со смещением стыков каждого слоя принимайте по альбому выбранной комплектной системы");
  }
  ...
  if (layers === 2) {
    practicalNotes.push("Калькулятор увеличивает количество листов и разделяет крепёж первого и второго слоя, но не проектирует раскладку и смещение стыков");
  }
  if (height > 3.5) {
  ...
  practicalNotes.push("Монтажные зазоры, деформационные швы и герметизацию примыканий выполняйте по альбому выбранной системы и условиям объекта — универсальный размер калькулятор не назначает");
